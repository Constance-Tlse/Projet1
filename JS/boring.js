function makepost(post) {
    ...
    const new_postuseravatar = document.createElement("div").classList.add("postuseravatar")
    const new_useravatar = document.createElement("img").classList.add("useravatar")
    const new_userinformation = document.createElement("div").classList.add("userinformation")
    ...
    const new_postcontent = document.createElement("div").classList.add("postcontent")
    ...
    const new_postinteraction = document.createElement("div").classList.add("postinteraction")
    ...
    const new_li_messages = document.createElement("li").classList.add("messages")
    ...
    const int_messages = document.createElement("img").setAttribute("alt", "messages")
    const int_retweet = document.createElement("img").setAttribute("alt", "retweet")
